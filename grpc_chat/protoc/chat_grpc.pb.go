...
const (
	ChatService_SendMessage_FullMethodName = "/grpcchat.ChatService/SendMessage"
	ChatService_Broadcast_FullMethodName   = "/grpcchat.ChatService/Broadcast"
)
...
func (x *chatServiceBroadcastClient) Send(m *MessageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatServiceBroadcastClient) Recv() (*MessageResponse, error) {
...
func (x *chatServiceBroadcastServer) Send(m *MessageResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatServiceBroadcastServer) Recv() (*MessageRequest, error) {
